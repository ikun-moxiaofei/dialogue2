...
public class DialogueController {
    ...
    public BaseResponse<ConversationResponse> saveConversation(@RequestBody ConversationRequest conversationRequest, HttpServletRequest request) {
        ...
        String conversationId1 = conversationRequest.getConversationId();
        Long conversationId = Long.parseLong(conversationId1);
//        Long conversationId = conversationRequest.getConversationId();
        Message tempMessage = conversationRequest.getTemp_message();
        String userId1 = conversationRequest.getUserId();
    ...
    public BaseResponse<NewResponse> newConversation(HttpServletRequest request) {
        ...
        if(systemId != null){
            ...
            newResponse.setContent("您好，我是M-CP5矿山智能运维助手，请问有什么可以帮助您的？");
...
//        Long systemId = loginUser.getId();
    ...
    public ResponseEntity<List<Message>> getMessages(@RequestParam("userId") String userId, @RequestParam("conversationId") String conversationId) {
//        String conversationId1 = conversationRequest.getConversationId();
        Long userId1 = Long.parseLong(userId);
        Long conversationId1 = Long.parseLong(conversationId);
        List<Message> messages = conversationService.getMessages(userId1, conversationId1);
        if (messages != null) {
